...
const TOOLS = [
  ...
  },
  {
    ...
    img: '/tools/roi.png',
    tagline: 'Build a financial model of your business',
    desc: 'Model TCO, ROI, NPV, payback and value drivers over 3 years - with benchmarks, risk adjustment, and a live sensitivity simulator.',
    cta: 'Model my impact',
    path: '/dashboard/business-impact',
  },
  {
    icon: DollarSign,
    ...
    img: '/tools/cost.png',
    tagline: 'Answer a few questions, get a real estimate',
    desc: 'A guided questionnaire maps your requirements to hours, timeline, and an investment range - with MVP, Business, and Enterprise options.',
    cta: 'Start estimating',
    path: '/dashboard/project-estimator',
  },
  {
    icon: Clock,
